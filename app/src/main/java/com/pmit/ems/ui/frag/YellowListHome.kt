...
import com.pmit.ems.databinding.YellowListHomeBinding
...
class YellowListHome : NetworkObserverFragment(), ViewTreeObserver.OnScrollChangedListener,
    View.OnClickListener {
    private lateinit var mBinding: YellowListHomeBinding
    ...
    var followup: LeadViewAdapter2? = null
    companion object {
    ...
    override fun onCreateView(
        ...
        mBinding = YellowListHomeBinding.inflate(inflater, container, false)
...
//                            String currentpage = Object.getString("current_page");
    ...
    class LeadViewAdapter(private val mCtx: Context, private val leadModels: List<LeadModel>) :
        ...
        override fun onBindViewHolder(
            ...
            holder.color_image.setImageDrawable(mCtx.resources.getDrawable(R.drawable.yellowlist))
                    ...
                    try {
                        ...
                        if (status1 == "true") {
                            ...
                            if (status == "active") {
                                ...
                                intent.putExtra("ListFlag", "yellow-list")
