...
//    SwipeRefreshLayout swipeRefresh;
    ...
    ImageView ImgZip;
    String searchName="";
    String listtype = "Green List";
    AppCompatImageView homeHeaderNavBtn;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.green_list_home);
...
//            holder.led_tv5.setBackgroundColor(Color.parseColor(leadModel.getColorCode()));
            ...
            holder.color_image.setImageDrawable(mCtx.getResources().getDrawable(R.drawable.greenlist));
