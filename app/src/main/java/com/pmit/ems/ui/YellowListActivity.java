...
//            holder.led_tv5.setBackgroundColor(Color.parseColor(leadModel.getColorCode()));
            ...
            holder.color_image.setImageDrawable(mCtx.getResources().getDrawable(R.drawable.yellowlist));
...
//                    holder.Img_Id.setImageDrawable(mCtx.getResources().getDrawable(R.drawable.tag4));
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            private ImageView Img_Id,color_image;
            RelativeLayout rv;
            public ViewHolder(View view) {
                ...
                color_image = (ImageView) view.findViewById(R.id.color_image);
