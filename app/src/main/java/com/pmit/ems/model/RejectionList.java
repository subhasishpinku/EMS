...
public class RejectionList {
    ...
    public RejectionList(String id, String fname, String mname, String lname, String mobile_no, String whatsapp_no, String email, String srn_no,
     String father_name, String guardian_name, String mother_name, String dob, String photo, String course_name, String collegename,
     String session_value, String booking_amount, String transaction_id,String source_id,String course_id,String session_id,String college_id){
        this.id=id;
        this.fname=fname;
        this.mname=mname;
        this.lname=lname;
