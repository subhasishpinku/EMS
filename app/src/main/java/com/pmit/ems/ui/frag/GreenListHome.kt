...
import com.pmit.ems.databinding.GreenListHomeBinding
...
class GreenListHome : NetworkObserverFragment(), ViewTreeObserver.OnScrollChangedListener,
    View.OnClickListener {
    private lateinit var mBinding: GreenListHomeBinding
    ...
    override fun onCreateView(
        ...
        mBinding = GreenListHomeBinding.inflate(inflater, container, false)
...
//                            String currentpage = Object.getString("current_page");
    ...
    class LeadViewAdapter(private val mCtx: Context, private val leadModels: List<LeadModel>) :
        ...
        override fun onBindViewHolder(
            ...
            holder.color_image.setImageDrawable(mCtx.resources.getDrawable(R.drawable.greenlist))
                    ...
                    try {
                        ...
                        if (status1 == "true") {
                            ...
                            if (status == "active") {
                                ...
                                intent.putExtra("ListFlag", "green-list")
